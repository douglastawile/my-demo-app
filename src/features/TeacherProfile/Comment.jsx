...
const Comment = () => {
  return (
    <>
      ...
      <Card className="my-3 mx-2 shadow-sm rounded-4 bg-secondary text-white-50">
        <Card.Body>
          <div className="d-flex">
            ...
            />
            <div>
              <h6 className="mb-0 text-white-50">{commentData.author}</h6>
              <small className="text-muted">{commentData.timestamp}</small>
            </div>
          </div>
          <Card.Text className="mt-2 text-muted text-white-50">

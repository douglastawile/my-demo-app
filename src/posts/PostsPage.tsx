...
export default function PostsPage() {
  return (
    <section>
      <div className="flex flex-col mb-2 max-w-2xl p-6 space-y-6 overflow-hidden rounded-lg shadow-lg dark:bg-gray-800 h-screen">
        ...
        <div>
          ...
          />
          <h2 className="mb-1 text-xl font-semibold dark:text-gray-300">
        ...
        <div className="flex flex-wrap justify-between">
          <div className="space-x-2">
            <Link
              ...
              type="button"
              className="p-2 text-center text-blue-700"
            >
              Read more...
            </Link>
          </div>
